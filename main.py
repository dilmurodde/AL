...
# --- SOZLAMALAR ---
# Sizning ma'lumotlaringiz kodning ichiga joylandi
...
async def start_handler(message: Message):
    await message.answer(
        "Salom! Men sizning mutlaqo BEPUL AI yordamchingizman.\n\n"
        "Men Google Gemini AI yordamida ishlayman va quyidagilarni qila olaman:\n"
        "1. 💻 Murakkab kodlar yozish\n"
        "2. 💡 G'oyalaringizni mukammal loyihalarga aylantirish\n"
...
async def chat_handler(message: Message):
    ...
    try:
        # Gemini-ga so'rov yuborish uchun prompt tayyorlash
        prompt = (
